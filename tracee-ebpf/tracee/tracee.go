...
import (
	...
	"github.com/aquasecurity/tracee/tracee-ebpf/tests/initlogic"
...
func New(cfg Config) (*Tracee, error) {
	...
	printObj, err := newEventPrinter(t.config.Output.Format, ContainerMode, outf, errf, t.ProducerChannel)
	if err != nil {
		return nil, err
	}
	t.printer = printObj
